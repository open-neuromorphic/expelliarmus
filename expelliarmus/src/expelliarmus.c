...
LIBRARY_API event_array_t read_dat(const char* fpath, size_t* dim, size_t buff_size){
...
LIBRARY_API event_array_t read_evt2(const char* fpath, size_t* dim, size_t buff_size){
	FILE* fp = fopen(fpath, "rb"); 
	CHECK_FILE(fp, fpath); 
...
LIBRARY_API event_array_t read_evt3(const char* fpath, size_t* dim, size_t buff_size){
	FILE* fp = fopen(fpath, "rb"); 
	CHECK_FILE(fp, fpath); 
...
LIBRARY_API size_t cut_dat(const char* fpath_in, const char* fpath_out, size_t max_nevents, size_t buff_size){
...
LIBRARY_API size_t cut_evt2(const char* fpath_in, const char* fpath_out, size_t max_nevents, size_t buff_size){
	FILE* fp_in = fopen(fpath_in, "rb"); 
	CHECK_FILE(fp_in, fpath_in); 
	FILE* fp_out = fopen(fpath_out, "wb"); 
	CHECK_FILE(fp_out, fpath_out); 
...
LIBRARY_API size_t cut_evt3(const char* fpath_in, const char* fpath_out, size_t max_nevents, size_t buff_size){
	FILE* fp_in = fopen(fpath_in, "rb"); 
	CHECK_FILE(fp_in, fpath_in); 
